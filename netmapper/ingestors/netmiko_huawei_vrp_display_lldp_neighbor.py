"""Ingestor for netmiko_huawei_vrp_display_lldp_neighbor."""
...
def ingest(log):
    ...
    for item in log.parsed_output:
        # See https://github.com/networktocode/ntc-templates/tree/master/tests/huawei_vrp/display_lldp_neighbor # pylint: disable=line-too-long
