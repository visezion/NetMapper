"""Ingestor for netmiko_cisco_xr_show_ip_route."""
__author__ = "Andrea Dainese"
__contact__ = "andrea@adainese.it"
__copyright__ = "Copyright 2022, Andrea Dainese"
__license__ = "GPLv3"

from netmapper.schemas import interface, vrf, routetableentry
...
def ingest(log):
    ...
    for item in log.parsed_output:
        ...
        nexthop_ip = (
            item.get("next_hop")
            if item.get("next_hop") and item.get("next_hop") != "connected"
            else None
        )
