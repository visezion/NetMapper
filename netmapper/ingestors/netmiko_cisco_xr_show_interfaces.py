"""Ingestor for netmiko_cisco_xr_show_interfaces."""
...
def ingest(log):
    ...
    for item in log.parsed_output:
        # See https://github.com/networktocode/ntc-templates/tree/master/tests/cisco_xr/show_interfaces # pylint: disable=line-too-long
