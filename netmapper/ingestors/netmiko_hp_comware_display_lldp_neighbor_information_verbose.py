"""Ingestor for netmiko_hp_comware_display_lldp_neighborinformation_verbose."""
...
def ingest(log):
    ...
    for item in log.parsed_output:
        # See https://github.com/networktocode/ntc-templates/tree/master/tests/hp_comware/display_lldp_neighbor-information_verbose # pylint: disable=line-too-long
