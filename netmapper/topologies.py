...
from netmapper.dictionaries import DeviceImageChoices, DRAWIO_ROLE_MAP
    ...
    for interface_o in interface_list:
        ...
        if device_id not in nodes:
            ...
            if device_role in [key for key, value in DeviceImageChoices()]:
                image_url = f"/static/netmapper/img/{device_role}.png"
            else:
                image_url = "/static/netmapper/img/unknown.png"
            nodes[device_id] = {
                "id": device_id,
        ...
        if link_id not in links and from_site_id != to_site_id:
            ...
            if from_site_id not in sites:
                sites[from_site_id] = {
                    ...
                    "image": "/static/netmapper/img/site.png",
                    "shape": "image",
